...
#         first_alpha=password[0].isalpha()
#         if all(c.isalpha() == first_alpha for c in password):
#             raise forms.ValidationError('密码应含有字母和数字')
...
#             raise forms.ValidationError('您的密码过短')
#         first_alpha=new_password[0].isalpha()
#         if all(c.isalpha() == first_alpha for c in new_password):
#             raise forms.ValidationError('密码应含有字母和数字')      
#         return self.cleaned_data
