...
.box {
  box-shadow: 0 0 2px rgba(255,255,255,0.3), -1px -1px 0 #fcfcfc, 2px 2px 0 #ccc;
  /* 32px 18px 21px -3px rgba(0, 0, 0, 0.253); */
  width: 50rem;
  height: 35rem;
  border-radius: 4rem;
  background-color: transparent;
  border-color: #f3f4f6;
  border: #aed7ec 1px solid;
}
